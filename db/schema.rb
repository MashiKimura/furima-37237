...
ActiveRecord::Schema.define(version: 2021_12_25_065619) do
  ...
  create_table "shipping_items", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["purchase_item_id"], name: "index_shipping_items_on_purchase_item_id"
  end
  ...
  add_foreign_key "shipping_items", "purchase_items"
end
